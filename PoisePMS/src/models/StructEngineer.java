...
public class StructEngineer {
  ...
  /**
   * Below is the constructor that will create the StructEngineer Object using the
   * parameters strings as attributes.
   * 
   ...
   *                        the object.
   */
  public StructEngineer(String surname, String name, String telephoneNumber, String address, String physicalAddress) {
