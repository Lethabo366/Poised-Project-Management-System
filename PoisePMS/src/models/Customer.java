...
public class Customer {
  /*
   * This class has 5 attributes all strings surname,name,telephone
   * Number,emailAddress and physicalAddress
   */
  String surname;
  String name;
   ...
   *                        the object.
   */
  public Customer(String surname, String name, String telephoneNumber, String address, String physicalAddress) {
    super();
  ...
  /**
   * The method below returns the Name attribute of the object.
   * @return returns the telephoneNumber attribute of the object.
   */
